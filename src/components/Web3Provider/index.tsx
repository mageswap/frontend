import { sendAnalyticsEvent, user } from '@mageswap/analytics'
import { CustomUserProperties, InterfaceEventName, WalletConnectionResult } from '@mageswap/analytics-events'
import { getWalletMeta } from '@mageswap/conedison/provider/meta'
