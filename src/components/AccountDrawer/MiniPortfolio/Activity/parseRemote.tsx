...
const UNI_IMG =
  'https://raw.githubusercontent.com/mageswap/assets/master/blockchains/ethereum/assets/0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984/logo.png'
...
const COMMON_CONTRACTS: { [key: string]: Partial<Activity> | undefined } = {
  [UNI_ADDRESS[SupportedChainId.FANTOM].toLowerCase()]: {
    title: t`POTION Governance`,
