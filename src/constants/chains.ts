/**
 * SupportedChainId must be defined inline, without using @mageswap/sdk-core, so that its members are their own types
 ...
 *
 * Because this is not explicitly derived from @mageswap/sdk-core, there is a unit test to enforce conformance.
 */
